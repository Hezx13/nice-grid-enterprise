...
export function validGridChartsVersionErrorMessage({
    ...
    const invalidMessage =
        'NICE Grid: NICE Grid version is incompatible. Please see https://www.ag-grid.com/javascript-data-grid/modules/ for more information.';
    ...
    if (type === 'incompatible') {
        return `NICE GRID version ${gridVersion} and AG Charts version ${chartsVersion} is not supported. NICE Grid version ${gridMajorMinor} should be used with AG Chart ${chartsMajorMinor}. Please see https://www.ag-grid.com/javascript-data-grid/modules/ for more information.`;
    } else if (type === 'invalidCharts') {
        return `NICE Grid version ${gridMajorMinor} should be used with AG Chart ${chartsMajorMinor} not ${chartsVersion}. Please see https://www.ag-grid.com/javascript-data-grid/modules/ for more information.`;
    }
